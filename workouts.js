        ...
        .then(function(snapshot) {
            if (!snapshot.empty) {
                ...
                snapshot.forEach(function(doc) {
                    console.log("Документ получен:", doc.id, doc.data());
                    ...
                    var muscletypeadditional = doc.data().muscletypeadditional || "Не указано";
                    ...
                    if (photoUrl) {
                        ...
                        img.src = photoUrl;
                        img.alt = "Изображение упражнения";
                        img.style.maxWidth = "200px";
                        photoItem.appendChild(img);
                        attributes.appendChild(photoItem);
                    }
                    ...
                    var additionalMusclesItem = document.createElement("li");
                    additionalMusclesItem.textContent = "Доп. мышцы: " + muscletypeadditional;
                    attributes.appendChild(additionalMusclesItem);
                    ...
                    if (videoUrl) {
                        ...
                        attributes.appendChild(videoItem);
                    }
